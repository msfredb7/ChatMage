...
public class JesusSearchRockBehavior : EnemyBehavior<JesusV2Vehicle>
{
    ...
    public JesusSearchRockBehavior(JesusV2Vehicle vehicle, Action<JesusRockV2> onComplete) : base(vehicle)
    {
